...
if __name__ == "__main__":
    ...
    create_dir("final_data/train/image/")
    create_dir("final_data/train/mask/")
    create_dir("final_data/test/image/")
    create_dir("final_data/test/mask/")

    """ Data augmentation """
    augment_data(train_x, train_y, "final_data/train/", augment=True)
    augment_data(test_x, test_y, "final_data/test/", augment=False)
